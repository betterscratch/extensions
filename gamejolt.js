...
/* generated l10n code */Scratch.translate.setup({"ca":{"_Close":"Tanca"},"cs":{"_Close":"Zavřít"},"de":{"_Close":"Schließen"},"es":{"_Close":"Cerrar"},"fr":{"_Close":"Fermer"},"hu":{"_Close":"Bezárás"},"it":{"GameJoltAPI_gamejoltBool":"su Game Jolt","_1 point":"1 punto","_Achieve trophy of ID [ID]":"ottieni trofeo con ID [ID]","_Add [username] score [value] in table of ID [ID] with text [text] and comment [extraData]":"aggiungi punteggio [value] a utente [username]nella tabella con ID [ID] con testo [text] e commento [extraData]","_Add score [value] in table of ID [ID] with text [text] and comment [extraData]":"aggiungi punteggio [value] nella tabella con ID [ID] con testo [text] e commento [extraData]","_Autologin available?":"accesso automatico disponibile","_Close":"Chiudi","_Data Storage Blocks":"Blocchi Memorizzazione Dati","_Debug Blocks":"Blocchi Debug","_Fetch [amount] [globalOrPerUser] score/s [betterOrWorse] than [value] in table of ID [ID]":"recupera [amount][globalOrPerUser] [betterOrWorse] di [value] nella tabella con ID [ID]","_Fetch [amount] [globalOrPerUser] score/s in table of ID [ID]":"recupera [amount][globalOrPerUser] nella tabella con ID [ID]","_Fetch [amount] [username] score/s [betterOrWorse] than [value] in table of ID [ID]":"recupera [amount]dell'utente[username] [betterOrWorse] di [value] nella tabella con ID [ID]","_Fetch [amount] [username] score/s in table of ID [ID]":"recupera [amount][username]nella tabella con ID [ID]","_Fetch [globalOrPerUser] keys matching with [pattern]":"recupera tutte le chiavi [globalOrPerUser] corrispondenti a [pattern]","_Fetch [trophyFetchGroup] trophies":"recupera [trophyFetchGroup]","_Fetch all [globalOrPerUser] keys":"recupera tutte le chiavi [globalOrPerUser]","_Fetch logged in user":"recupera utente collegato","_Fetch server's time":"restituisci ora del server","_Fetch trophy of ID[ID]":"recupera trofeo con ID [ID]","_Fetch user's [usernameOrID] by [fetchType]":"restituisci dati utente con [fetchType] [usernameOrID]","_Fetch user's friend IDs":"recupera ID amici dell'utente","_Fetched score [scoreDataType] at index [index]":"[trophyDataType] del punteggio recuperato alla posizione [index]","_Fetched score data in JSON":"converti in JSON i dati del punteggio recuparato","_Fetched trophies in JSON":"converti in JSON trofei recuperati  ","_Fetched trophy [trophyDataType] at index [index]":"[trophyDataType] del trofeo alla posizione [index]","_Fetched user's [userDataType]":"[userDataType] dell'utente collegato","_Fetched user's data in JSON":"dati recuperati dell'utente in JSON ","_Fetched user's friend ID at index[index]":"ID recuperato in posizione [index] degli amici dell'utente","_Fetched user's friend IDs in JSON":"ID recuperati degli amici dell'utente in JSON ","_In debug mode?":"modalità debug attiva","_Last API error":"ultimo errore API","_Logged in user's username":"username dell'utente collegato","_Logged in?":"collegato","_Login automatically":"accedi automaticamente","_Login with [username] and [token]":"collegati con [username] e [token]","_Logout":"esci","_Open":"Apri","_Ping session":"ping sessione","_Remove [globalOrPerUser] data at [key]":"rimuovi dati [globalOrPerUser] alla chiave [key]","_Remove trophy of ID [ID]":"Rimuovi trofeo con ID [ID]","_Score Blocks":"Blocchi Punteggio","_Session Blocks":"blocchi sessione","_Session open?":"sessione aperta","_Set game ID to [ID] and private key to [key]":"imposta ID gioco a [ID] e chiave privata a [key]","_Set session status to [status]":"porta stato sessione a [status]","_Time Blocks":"Blocchi Tempo","_Trophy Blocks":"Blocchi Trofeo","_Turn debug mode [toggle]":" [toggle] modalità debug","_Update [globalOrPerUser] data at [key] by [operationType] [value]":"aggiorna dati [globalOrPerUser] alla chiave [key]  [operationType] [value]","_User Blocks":"Blocchi Utente","_[openOrClose] session":"[openOrClose] sessione","_achievement date":"data risultato","_active":"attivo","_adding":"aggiungendo","_all":"tutti i trofei","_all achieved":"tutti i trofei ottenuti","_all unachieved":"tutti i trofei non ottenuti","_appending":"aggiungendo","_avatar URL":"URL avatar","_better":"megliori","_comment":"commento","_data":"dati","_day":"giorno","_description":"descrizione","_developer username":"username svilppatore","_difficulty":"difficoltà","_dividing by":"dividendo per","_global":"globali","_guest":"ospite","_hour":"ora","_idle":"sospeso","_image URL":"URL immagine","_in parallel":"in parallelo","_index":"posizione","_key":"chiave","_last login":"ultimo accesso","_last login timestamp":"timestap ultimo accesso","_minute":"minuti","_month":"mese","_multiplying by":"mutiplicando per","_name":"nome","_off":"disabilita","_on":"abilita","_optional":"opzionale","_prepending":"inserendo all'inizio","_primary":"primario","_private key":"chiave privata","_private token":"token privato","_score date":"data puntaggio","_score timestamp":"timestamp punteggio","_second":"secondi","_sequentially":"sequenzialmente","_sequentially, break on error":"sequenzialmente, ma arresta in casa di errore","_sign up date":"data registrazione","_sign up timestamp":"timestamp registrazione","_status":"stato","_subtracting":"sottraendo","_text":"testo","_timezone":"fuso orario","_title":"titolo","_type":"effetto digitazione","_user":"dell'utente","_user ID":"ID utente","_value":"valore","_website":"sito","_worse":"peggiori","_year":"anno"},"ja":{"_Close":"閉じる"},"ja-hira":{"_Close":"とじる"},"ko":{"_Close":"닫기"},"lt":{"_Close":"Uždaryti"},"nl":{"GameJoltAPI_gamejoltBool":"op Game Jolt?","_1 point":"1 punt","_Achieve trophy of ID [ID]":"geef trofee met ID [ID]","_Add [namespace] request with [parameters] to batch":"voeg [namespace] verzoek met [parameters] toe aan batch","_Add [username] score [value] in table of ID [ID] with text [text] and comment [extraData]":"voeg [username] score [value] toe in tabel [ID] met tekst [text] en opmerking [extraData]","_Add score [value] in table of ID [ID] with text [text] and comment [extraData]":"voeg score [value] toe in tabel [ID] met tekst [text] en opmerking [extraData]","_Autologin available?":"automatisch inloggen mogelijk?","_Batch in JSON":"batch in JSON","_Clear batch":"wis batch","_Close":"sluit","_Data Storage Blocks":"Gegevens Opslaan","_Debug Blocks":"Debuggen","_Fetch [amount] [globalOrPerUser] score/s [betterOrWorse] than [value] in table of ID [ID]":"vraag [amount] [globalOrPerUser] scores op in tabel [ID] die [betterOrWorse] zijn dan [value]","_Fetch [amount] [globalOrPerUser] score/s in table of ID [ID]":"vraag [amount] [globalOrPerUser] scores op in tabel [ID]","_Fetch [amount] [username] score/s [betterOrWorse] than [value] in table of ID [ID]":"vraag [amount] [username] scores op in tabel [ID] die [betterOrWorse] zijn dan [value]","_Fetch [amount] [username] score/s in table of ID [ID]":"vraag [amount] [username] scores op in tabel [ID]","_Fetch [globalOrPerUser] keys matching with [pattern]":"vraag alle [globalOrPerUser] keys op die overeenkomen met [pattern]","_Fetch [trophyFetchGroup] trophies":"vraag [trophyFetchGroup] trofeeën op","_Fetch all [globalOrPerUser] keys":"vraag alle [globalOrPerUser] keys op","_Fetch batch [parameter]":"vraag batch [parameter] op","_Fetch logged in user":"vraag ingelogde gebruiker op","_Fetch score tables":"vraag score-tabellen op","_Fetch server's time":"vraag servertijd op","_Fetch trophy of ID[ID]":"vraag trofee met ID [ID] op","_Fetch user's [usernameOrID] by [fetchType]":"vraag gebruiker [usernameOrID] op met [fetchType] ","_Fetch user's friend IDs":"vriend-ID's van opgevraagde gebruiker","_Fetched [globalOrPerUser] data at [key]":"opgevraagde [globalOrPerUser] data bij [key]","_Fetched batch data in JSON":"opgevraagde batchgegevens in JSON","_Fetched key at index [index]":"opgevraagde key bij index [index]","_Fetched keys in JSON":"opgevraagde keys in JSON","_Fetched rank of [value] in table of ID [ID]":"opgevraagde rang van [value] in tabel [ID]","_Fetched score [scoreDataType] at index [index]":"[scoreDataType] bij index [index] van opgevraagde score","_Fetched score data in JSON":"gegevens van opgevraagde score in JSON","_Fetched server's [timeType]":"opgevraagde [timeType] van servertijd","_Fetched server's time in JSON":"opgevraagde servertijd in JSON","_Fetched table [tableDataType] at index [index]":"[tableDataType] van opgevraagde tabel bij index [index]","_Fetched table [tableDataType] at index[index] (Deprecated)":"[tableDataType] van opgevraagde tabel bij index [index] (verouderd)","_Fetched tables in JSON":"opgevraagde tabellen in JSON","_Fetched trophies in JSON":"opgevraagde trofeeën in JSON","_Fetched trophy [trophyDataType] at index [index]":"[trophyDataType] van opgevraagde trofee op index [index]","_Fetched user's [userDataType]":"[userDataType] van opgevraagde gebruiker","_Fetched user's data in JSON":"JSON-gegevens van opgevraagde gebruiker","_Fetched user's friend ID at index[index]":"vriend [index] van opgevraagde gebruiker","_Fetched user's friend IDs in JSON":"vriend-ID's van opgevraagde gebruiker in JSON","_In debug mode?":"debug-modus actief?","_Last API error":"recentste API-fout","_Logged in user's username":"gebruikersnaam van ingelogd","_Logged in?":"ingelogd?","_Login automatically":"log automatisch in","_Login with [username] and [token]":"log in met gebruikersnaam [username] en token [token]","_Logout":"log uit","_Open":"open","_Ping session":"ping sessie","_Remove [globalOrPerUser] data at [key]":"verwijder [globalOrPerUser] data bij [key]","_Remove trophy of ID [ID]":"verwijder trofee met ID [ID]","_Score Blocks":"Score","_Session Blocks":"Sessie","_Session open?":"sessie open?","_Set [globalOrPerUser] data at [key] to [data]":"maak [globalOrPerUser] data bij [key] [data]","_Set game ID to [ID] and private key to [key]":"stel game-ID in op [ID] en privé-key op [key]","_Set session status to [status]":"stel sessie-status in op [status]","_Time Blocks":"Tijd","_Trophy Blocks":"Trofeeën","_Turn debug mode [toggle]":"schakel debug-modus [toggle]","_Update [globalOrPerUser] data at [key] by [operationType] [value]":"verander [globalOrPerUser] data bij [key] door [operationType] met [value]","_User Blocks":"Gebruikers","_[openOrClose] session":"[openOrClose] sessie","_achievement date":"datum behaald","_active":"actief","_adding":"optellen","_all":"alle","_all achieved":"alle behaalde","_all unachieved":"alle niet-behaalde","_appending":"toevoegen aan eind","_avatar URL":"avatar-URL","_better":"beter","_comment":"opmerking","_data":"gegevens","_day":"dag","_description":"beschrijving","_developer username":"ontwikkelaarsnaam","_difficulty":"moeilijkheid","_dividing by":"delen","_global":"globale","_guest":"gast","_hour":"uur","_idle":"inactief","_image URL":"afbeelding-URL","_in parallel":"parallel","_last login":"recentste inlogdatum","_last login timestamp":"recentste inlog-tijdstempel","_minute":"minuut","_month":"maand","_multiplying by":"vermenigvuldigen","_name":"naam","_off":"uit","_on":"in","_optional":"optioneel","_prepending":"toevoegen aan begin","_primary":"primair","_private key":"privé-key","_private token":"privé-token","_score date":"scoredatum","_score timestamp":"score-tijdstempel","_second":"seconde","_sequentially":"opeenvolgend","_sequentially, break on error":"opeenvolgend (stoppen bij fout)","_sign up date":"aanmelddatum","_sign up timestamp":"aanmeld-tijdstempel","_subtracting":"aftellen","_text":"tekst","_timestamp":"tijdstempel","_timezone":"tijdzone","_title":"titel","_user":"gebruikers","_user ID":"gebruiker-ID","_username":"gebruikersnaam","_value":"waarde","_worse":"slechter","_year":"jaar"},"pl":{"_Close":"Zamknij"},"pt":{"_Close":"Fechar"},"pt-br":{"_Close":"Fechar"},"ru":{"GameJoltAPI_gamejoltBool":"На Game Jolt?","_1 point":"1 балл","_Achieve trophy of ID [ID]":"Получить трофей с ID [ID]","_Add [namespace] request with [parameters] to batch":"Добавить [namespace] запрос с [parameters] в пакет","_Add [username] score [value] in table of ID [ID] with text [text] and comment [extraData]":"Добавить счет [value] от [username] в таблице с ID [ID] с текстом [text] и комментарием [extraData]  ","_Add score [value] in table of ID [ID] with text [text] and comment [extraData]":"Добавить счет [value] в таблицу с ID [ID] с текстом [text] и комментарием [extraData]","_Autologin available?":"Автоматический вход доступен?","_Batch in JSON":"Пакет в JSON","_Clear batch":" Очистить пакет","_Close":"Закрыть","_Data Storage Blocks":"Блоки Хранилища Данных","_Debug Blocks":"Блоки Отладки","_Fetch [amount] [globalOrPerUser] score/s [betterOrWorse] than [value] in table of ID [ID]":"Найти [amount] [globalOrPerUser] счет/а [betterOrWorse] чем [value] в таблице с ID [ID]","_Fetch [amount] [globalOrPerUser] score/s in table of ID [ID]":"Найти [amount] [globalOrPerUser] счет/а в таблице с ID [ID]","_Fetch [amount] [username] score/s [betterOrWorse] than [value] in table of ID [ID]":"Найти [amount] счет/а от [username] [betterOrWorse] чем [value] в таблице с ID [ID]","_Fetch [amount] [username] score/s in table of ID [ID]":"Найти [amount] счет/а от [username] в таблице с ID [ID]","_Fetch [globalOrPerUser] keys matching with [pattern]":"Найти [globalOrPerUser] ключи по шаблону [pattern]","_Fetch [trophyFetchGroup] trophies":"Найти [trophyFetchGroup] трофеи","_Fetch all [globalOrPerUser] keys":"Найти все [globalOrPerUser] ключи ","_Fetch batch [parameter]":"[parameter] пакетный запрос ","_Fetch logged in user":"Найти данные текущего пользователя","_Fetch score tables":"Найти таблицы счета","_Fetch server's time":"Найти время сервера","_Fetch trophy of ID[ID]":"Найти трофей с ID [ID]","_Fetch user's [usernameOrID] by [fetchType]":"Найти данные пользователя [usernameOrID] через [fetchType]","_Fetch user's friend IDs":"Найти ID друзей пользователя","_Fetched [globalOrPerUser] data at [key]":"Найденный [globalOrPerUser] [key]","_Fetched batch data in JSON":"Найденные данные пакетного запроса в JSON","_Fetched key at index [index]":"Найденный ключ по индексу [index]","_Fetched keys in JSON":"Найденные ключи в JSON","_Fetched rank of [value] in table of ID [ID]":"Найденное место счета [value] в таблице с ID [ID]","_Fetched score [scoreDataType] at index [index]":"Найденные данные [scoreDataType] счета  по индексу [index]","_Fetched score data in JSON":"Найденные данные счета/ов в JSON","_Fetched server's [timeType]":"Найденные данные [timeType] сервера","_Fetched server's time in JSON":"Найденное время сервера в JSON","_Fetched table [tableDataType] at index [index]":"Найденные данные [tableDataType] таблицы по индексу [index]","_Fetched tables in JSON":"Найденные данные таблиц в JSON","_Fetched trophies in JSON":"Найденные трофеи в JSON","_Fetched trophy [trophyDataType] at index [index]":"Найденные данные [trophyDataType] трофея  по индексу [index]","_Fetched user's [userDataType]":"Найденные данные [userDataType] пользователя ","_Fetched user's data in JSON":"Найденные данные пользователя в JSON","_Fetched user's friend ID at index[index]":"Найденный ID друга пользователя по индексу [index]","_Fetched user's friend IDs in JSON":"Найденные ID друзей пользователя в JSON","_In debug mode?":"В режиме отладки?","_Last API error":"Последняя ошибка API","_Logged in user's username":"Имя текущего пользователя","_Logged in?":"Вход совершен?","_Login automatically":"Войти автоматически","_Login with [username] and [token]":"Войти в аккаунт как [username] через [token]","_Logout":"Выйти из аккаунта","_Open":"Открыть","_Ping session":"Пинг сессии","_Remove [globalOrPerUser] data at [key]":"Удалить [globalOrPerUser] [key]","_Remove trophy of ID [ID]":"Убрать трофей с ID [ID]","_Score Blocks":"Блоки Счета","_Session Blocks":"Блоки Сессии","_Session open?":"Сессия открыта?","_Set [globalOrPerUser] data at [key] to [data]":"Задать [globalOrPerUser] [key] значение [data]","_Set game ID to [ID] and private key to [key]":"Задать ID игры как [ID] и приватный ключ как [key]","_Set session status to [status]":"Задать статус сессии в [status]","_Time Blocks":"Блоки Времени","_Trophy Blocks":"Блоки Трофеев","_Turn debug mode [toggle]":"[toggle] режим отладки","_Update [globalOrPerUser] data at [key] by [operationType] [value]":"Обновить [globalOrPerUser] [key] [operationType] [value]","_User Blocks":"Блоки Пользователей","_[openOrClose] session":"[openOrClose] сессию","_achievement date":"дата получения","_active":"активный","_adding":"прибавив","_all":"все","_all achieved":"все полученные","_all unachieved":"все не полученные","_appending":"добавив справа","_avatar URL":"URL аватара","_better":"лучше","_comment":"комментарий","_data":"данные","_day":"день","_description":"описание","_developer username":"имя разработчика","_difficulty":"сложность","_dividing by":"делением на","_global":"глобальный","_guest":"гость","_hour":"час","_idle":"неактивный","_image URL":"URL картинки","_in parallel":"Параллельный","_index":"индекс","_key":"ключ","_last login":"последний вход","_last login timestamp":"временной штамп последнего входа","_minute":"минута","_month":"месяц","_multiplying by":"умножением на","_name":"имя","_off":"Выключить","_on":"Включить","_optional":"опционально","_prepending":"добавив слева","_primary":"основная","_private key":"приватный ключ","_private token":"приватный токен","_score date":"дата получения счета","_score timestamp":"временной штамп получения счета","_second":"секунда","_sequentially":"Последовательный","_sequentially, break on error":"Последовательный, прервать при ошибке","_sign up date":"дата регистрации","_sign up timestamp":"временной штамп регистрации","_status":"статус","_subtracting":"убавив","_text":"текст","_timestamp":"временной штамп","_timezone":"часовой пояс","_title":"название","_type":"тип","_user":"пользовательский","_user ID":"ID пользователя","_username":"имя пользователя","_value":"значение","_website":"вебсайт","_worse":"хуже","_year":"год"},"sl":{"_Close":"Zapri"},"sv":{"_Close":"Stäng"},"tr":{"_Close":"Kapat"},"uk":{"_Close":"Закрити"},"zh-cn":{"_Close":"关闭","_name":"名字","_off":"关闭 ","_on":"打开","_text":"文本","_title":"标题","_type":"类型","_user ID":"用户ID","_value":"值"},"zh-tw":{"_Close":"關閉"}});/* end generated l10n code */((Scratch) => {
  "use strict";
