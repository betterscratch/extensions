...
/* generated l10n code */Scratch.translate.setup({"de":{"_Sound":"Klänge"},"it":{"_Sound":"Suoni","_play sound from url: [path] until done":"avvia riproduzione suono da url: [path] e attendi la fine","_start sound from url: [path]":"riproduci suono da url: [path]"},"nl":{"_Sound":"Geluid","_play sound from url: [path] until done":"start geluid van URL: [path] en wacht","_start sound from url: [path]":"start geluid van URL: [path]"},"ru":{"_Sound":"Звук","_play sound from url: [path] until done":"играть звук из url: [path] до конца","_start sound from url: [path]":"включить звук из url: [path]"},"zh-cn":{"_Sound":"声音","_play sound from url: [path] until done":"播放URL[path]的声音直到结束","_start sound from url: [path]":"播放URL[path]的声音"}});/* end generated l10n code */((Scratch) => {
  "use strict";
