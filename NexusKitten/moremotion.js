...
/* generated l10n code */Scratch.translate.setup({"de":{"_More Motion":"Mehr Bewegung"},"it":{"_More Motion":"Movimento Plus","_change x: [X] y: [Y]":"cambia x di [X] y di [Y]","_costume height":"altezza costume","_costume width":"larghezza costume","_direction to x: [X] y: [Y]":"direzione verso x: [X] y: [Y]","_distance from x: [X] y: [Y]":"distanza da x: [X] y: [Y]","_height":"altezza","_manually fence":"impedisci sprite fuori Stage","_move [PERCENT]% of the way to x: [X] y: [Y]":"percorri [PERCENT]% della distanza da x: [X] y: [Y]","_move [STEPS] steps towards x: [X] y: [Y]":"fai [STEPS] passi verso x: [X] y: [Y]","_point towards x: [X] y: [Y]":"punta verso x: [X] y: [Y]","_rotation style":"stile rotazione","_sprite [WHAT]":"[WHAT] dello sprite","_touching rectangle x1: [X1] y1: [Y1] x2: [X2] y2: [Y2]?":"sta toccando rettangolo x1: [X1] y1: [Y1] x2: [X2] y2: [Y2]","_touching x: [X] y: [Y]?":"sta toccando x: [X] y: [Y]","_width":"larghezza"},"nl":{"_More Motion":"Beweging Uitgebreid","_change x: [X] y: [Y]":"verander x: [X] y: [Y]","_costume height":"uiterlijkhoogte","_costume width":"uiterlijkbreedte","_direction to x: [X] y: [Y]":"richting naar x: [X] y: [Y]","_distance from x: [X] y: [Y]":"afstand tot x: [X] y: [Y]","_height":"hoogte","_manually fence":"beweeg naar binnen het scherm","_move [PERCENT]% of the way to x: [X] y: [Y]":"beweeg [PERCENT]% richting x: [X] y: [Y]","_move [STEPS] steps towards x: [X] y: [Y]":"neem [STEPS] stappen richting x: [X] y: [Y]","_point towards x: [X] y: [Y]":"richt naar x: [X] y: [Y]","_rotation style":"draaistijl","_sprite [WHAT]":"[WHAT] van sprite","_touching rectangle x1: [X1] y1: [Y1] x2: [X2] y2: [Y2]?":"raak ik een punt tussen x1: [X1] y1: [Y1] en x2: [X2] y2: [Y2]?","_touching x: [X] y: [Y]?":"raak ik x: [X] y: [Y]?","_width":"breedte"},"ru":{"_height":"высота","_width":"ширина"},"zh-cn":{"_More Motion":"更多运动","_costume height":"造型高度","_costume width":"造型宽度","_height":"高度","_touching x: [X] y: [Y]?":"触碰坐标x[X] y[Y]？","_width":"宽度"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
