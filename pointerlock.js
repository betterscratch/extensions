...
/* generated l10n code */Scratch.translate.setup({"it":{"_Pointerlock":"Blocco Puntatore","_disabled":"sblocca","_enabled":"blocca","_pointer locked?":"puntatore bloccato","_set pointer lock [enabled]":"[enabled] puntatore"},"nl":{"_Pointerlock":"Muisaanwijzer-Vergrendeling","_disabled":"ontgrendel","_enabled":"vergrendel","_pointer locked?":"muisaanwijzer vergrendeld?","_set pointer lock [enabled]":"[enabled] muisaanwijzer"},"ru":{"_disabled":"выключен","_enabled":"включен"},"zh-cn":{"_disabled":"禁用","_enabled":"启用"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
