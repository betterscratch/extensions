...
/* generated l10n code */Scratch.translate.setup({"it":{"_Ping Cloud Data":"Ping Dati Cloud","_is cloud data server [SERVER] up?":"il server cloud [SERVER] è attivo"},"nl":{"_Ping Cloud Data":"Cloudservers Pingen","_is cloud data server [SERVER] up?":"is cloud-gegevensserver [SERVER] bereikbaar?"},"ru":{"_Ping Cloud Data":"Пинг облачных данных","_is cloud data server [SERVER] up?":"Сервер облачных данных [SERVER] в сети?"},"zh-cn":{"_Ping Cloud Data":"检测云数据"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
