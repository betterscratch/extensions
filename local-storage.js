...
/* generated l10n code */Scratch.translate.setup({"it":{"_Local Storage":"Memoria Locale","_Local Storage extension: project must run the \"set storage namespace ID\" block before it can use other blocks":"Estensione Archiviazone Locale: il progetto deve eseguire il blocco \"imposta ID spazio di archiviazione\" prima di usare gli altri blocchi","_delete all keys":"cancella tutte le chiavi","_delete key [KEY]":"cancella chiave [KEY]","_get key [KEY]":"valore della chiave [KEY]","_project title":"titolo progetto","_score":"punteggio","_set key [KEY] to [VALUE]":"imposta valore chiave [KEY] a [VALUE]","_set storage namespace ID to [ID]":"imposta ID spazio archiviazione a [ID]","_when another window changes storage":"quando altra finestra cambia spazio di archiviazione"},"ja":{"_get key [KEY]":"キーを取得[KEY]"},"nl":{"_Local Storage":"Lokale Opslag","_Local Storage extension: project must run the \"set storage namespace ID\" block before it can use other blocks":"Lokale Opslag-extensie: het project moet eerst een opslagnaamruimte-ID toegewezen krijgen voordat de andere blokken kunnen werken.","_delete all keys":"verwijder alle sleutels","_delete key [KEY]":"verwijder sleutel [KEY]","_get key [KEY]":"sleutel [KEY]","_project title":"projecttitel","_set key [KEY] to [VALUE]":"maak sleutel [KEY] [VALUE]","_set storage namespace ID to [ID]":"maak opslagnaamruimte-ID [ID]","_when another window changes storage":"wanneer een ander venster de opslag aanpast"},"zh-cn":{"_Local Storage":"本地存储","_Local Storage extension: project must run the \"set storage namespace ID\" block before it can use other blocks":"本地存储拓展：请先运行“设置存储命名空间ID”积木才能使用下面的积木","_delete all keys":"删除所有本地存储变量","_delete key [KEY]":"删除本地存储变量[KEY]","_get key [KEY]":"本地存储变量[KEY]的值","_project title":"作品标题","_score":"分数","_set key [KEY] to [VALUE]":"设置本地存储变量[KEY]的值为[VALUE]","_set storage namespace ID to [ID]":"设置存储命名空间ID为[ID]"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
