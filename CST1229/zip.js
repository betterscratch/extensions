...
/* generated l10n code */Scratch.translate.setup({"it":{"_1 (fast, large)":"1 (veloce, grande)","_9 (slowest, smallest)":"9 (più lento, piccolo)","_Hello, world?":"Ciao mondo","_[META] of [FILE]":"[META] di [FILE]","_[OBJECT] exists?":"[OBJECT] esiste","_any text":"qualunque testo","_archive comment":"commento archivio","_archive is open?":"l'archivio è aperto","_binary":"binario","_close archive":"chiudi archivio","_comment":"commento","_contents of directory [DIR]":"contenuto della cartella [DIR]","_create directory [DIR]":"crea cartella [DIR]","_create empty archive":"crea archivio vuoto","_current directory path":"percorso cartella attuale","_delete [FILE]":"cancella [FILE]","_file [FILE] as [TYPE]":"file [FILE] come [TYPE]","_folder":"cartella","_go to directory [DIR]":"vai alla cartella [DIR]","_long modification date":"date modifica lunga","_modification date":"data modifica","_modified days since 2000":"giorni modifica dal 2000","_name":"nome","_new file":"nuovo file","_new folder":"nuova cartella","_no compression (fastest)":"nessuna compressione (più veloce)","_open zip from [TYPE] [DATA]":"apri zip da [TYPE] [DATA]","_output zip type [TYPE] compression level [COMPRESSION]":"crea zip di tipo [TYPE] con livello di compressione [COMPRESSION]","_path":"percorso","_path [PATH] from [ORIGIN]":"percorso [PATH] da [ORIGIN]","_set [META] of [FILE] to [VALUE]":"imposta [META] di [FILE] a [VALUE]","_set archive comment to [COMMENT]":"imposta commento archivio a [COMMENT]","_string":"stringa","_text":"testo","_unix modified timestamp":"timestamp unix modifica","_write file [FILE] content [CONTENT] type [TYPE]":"scrivi file [FILE] con contenuto [CONTENT] e tipo [TYPE]"},"nl":{"_1 (fast, large)":"1 (snel, groot)","_9 (slowest, smallest)":"9 (traagst, kleinst)","_Hello, world?":"Hallo... wereld?","_[META] of [FILE]":"[META] van [FILE]","_[OBJECT] exists?":"[OBJECT] bestaat?","_any text":"tekst","_archive comment":"archiefopmerking","_archive is open?":"archief open?","_binary":"binair","_close archive":"sluit archief","_comment":"opmerking","_contents of directory [DIR]":"inhoud van map [DIR]","_create directory [DIR]":"creëer map [DIR]","_create empty archive":"creëer leeg archief","_current directory path":"huidig map-pad","_delete [FILE]":"verwijder [FILE]","_file [FILE] as [TYPE]":"bestand [FILE] als [TYPE]","_folder":"map","_go to directory [DIR]":"ga naar map [DIR]","_long modification date":"lange wijzigingsdatum","_modification date":"wijzigingsdatum","_modified days since 2000":"wijzigingsdatum in dagen sinds 2000","_name":"naam","_new file":"bestand","_new folder":"nieuwe map","_no compression (fastest)":"geen (snelst)","_open zip from [TYPE] [DATA]":"open zip van [TYPE] [DATA]","_output zip type [TYPE] compression level [COMPRESSION]":"zip als [TYPE] met comprimeerniveau [COMPRESSION]","_path":"pad","_path [PATH] from [ORIGIN]":"pad [PATH] vanuit [ORIGIN] ","_set [META] of [FILE] to [VALUE]":"maak [META] van [FILE] [VALUE]","_set archive comment to [COMMENT]":"maak archiefopmerking [COMMENT]","_text":"tekst","_unix modified timestamp":"wijzigingsdatum in unix-tijdstempel","_write file [FILE] content [CONTENT] type [TYPE]":"nieuw bestand [FILE] inhoud [CONTENT] soort [TYPE]"},"ru":{"_comment":"комментарий","_name":"имя","_text":"текст"},"zh-cn":{"_Hello, world?":"你好世界？","_folder":"文件夹","_hex":"Hex","_name":"名字","_new file":"新文件","_new folder":"新文件夹","_path":"路径","_string":"字符串","_text":"文本"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
