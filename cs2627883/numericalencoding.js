...
/* generated l10n code */Scratch.translate.setup({"it":{"_Decode [ENCODED] back to text":"decodifica [ENCODED] in testo","_Encode [DATA] to numbers":"codifica [DATA] in numeri","_Hello!":"Ciao!","_Numerical Encoding":"Codifica Numerica","_decoded":"decodificato","_encoded":"codificato"},"ja":{"_Hello!":"こんにちは!"},"nl":{"_Decode [ENCODED] back to text":"decodeer [ENCODED] terug naar tekst","_Encode [DATA] to numbers":"codeer [DATA] naar getallen","_Hello!":"Hallo!","_Numerical Encoding":"Numerieke Codering","_decoded":"gedecodeerd","_encoded":"gecodeerd"},"ru":{"_Hello!":"Привет!"},"zh-cn":{"_Hello!":"你好！"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
