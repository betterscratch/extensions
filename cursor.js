...
/* generated l10n code */Scratch.translate.setup({"it":{"_Mouse Cursor":"Puntatore Mouse","_bottom left":"angolo sinistra in basso","_bottom right":"angolo destra in basso","_center":"centro","_cursor":"puntatore","_hide cursor":"nascondi puntatore","_set cursor to [cur]":"usa [cur] come puntatore","_set cursor to current costume center: [position] max size: [size]":"usa il costume attuale con centro: [position] dimensione massima: [size] come puntatore","_top left":"angolo sinistra in alto","_top right":"angolo destra in alto","_{size} (unreliable)":"{size} (inaffidabile)"},"ja":{"_Mouse Cursor":"マウスカーソル"},"nl":{"_Mouse Cursor":"Muisaanwijzer","_bottom left":"linksonder","_bottom right":"rechtsonder","_center":"midden","_hide cursor":"verberg cursor","_set cursor to [cur]":"maak cursor [cur]","_set cursor to current costume center: [position] max size: [size]":"maak cursor huidig uiterlijk met middelpunt: [position] en max. grootte: [size]","_top left":"linksboven","_top right":"rechtsboven","_{size} (unreliable)":"{size} (onbetrouwbaar)"},"ru":{"_Mouse Cursor":"Курсор Мыши","_bottom left":"нижнем левом углу","_bottom right":"нижнем правом углу","_center":"центре","_cursor":"курсор","_hide cursor":"спрятать курсор","_set cursor to [cur]":"изменить курсор на [cur]","_set cursor to current costume center: [position] max size: [size]":"изменить курсор на текущий костюм с центром в: [position] максимальным размером: [size]","_top left":"верхнем левом углу","_top right":"верхнем правом углу","_{size} (unreliable)":"{size} (ненадежно)"},"zh-cn":{"_Mouse Cursor":"鼠标图标","_center":"居中"}});/* end generated l10n code */(function (Scratch) {
  "use strict";
